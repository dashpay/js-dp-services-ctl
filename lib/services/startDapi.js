  ...
  for (let i = 0; i < number; i++) {
    ...
    const instance = {
      ...
      clean: async function clean() {
        ...
        instance.mongoDb = newServices.mongoDb;
        instance.ipfs = newServices.ipfs;
        instance.dashCore = newServices.dashCore;
        instance.driveApi = newServices.driveApi;
        instance.driveSync = newServices.driveSync;
        instance.insightApi = newServices.insightApi;
        instance.dapiTxFilterStream = newServices.dapiTxFilterStream;
        instance.dapiCore = newServices.dapiCore;
      },
